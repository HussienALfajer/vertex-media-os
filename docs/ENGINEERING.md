...
Prisma transaction clients and other infrastructure transaction handles MUST NOT appear in a module's public surface or in domain code. No generic unit-of-work or transaction-orchestration abstraction is introduced until a concrete cross-module case requires it.
